 ...
 * @author ana
 */
public class Formas_de_Pagamento_TFs_CBs_Inicio {
    
    Home Home;
    Formas_de_Pagamento_Home Formas_de_Pagamento_Home;
    
    public Formas_de_Pagamento_TFs_CBs_Inicio( Home Home2, Formas_de_Pagamento_Home Formas_de_Pagamento_Home2 ) {
