 ...
 * @author ana
 */
public class RetornarNumeroFloat {
    ...
    public static float floatTF( JTextField tf, String n, String nomecampo, boolean aceitar_nulo ) {

        return floatn( tf.getText().trim(), nomecampo, aceitar_nulo ); 
    }
    
    private static float  floatn( String n, String campo, boolean aceitar_nulo ) {
...
//    }
    public static void main(String[] args) {
        if( floatn( "0", "Quantidade", false ) == 0 ){
