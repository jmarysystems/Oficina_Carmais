 ...
 * @author ana
 */
public class OS_Botao_Novo_PressionadoInicio {
    
    public OS_Botao_Novo_PressionadoInicio( OS OS2, Home Home2, boolean botao2, boolean tf_cbs2 ) {
            ...
            public void run() {
                while ( um == false ) {     um = true;
                    try { Thread.sleep(1); 
                        ...
                        JOptionPaneMod JOptionPaneMod = new JOptionPaneMod( 2, "OS_Botao_Novo_PressionadoInicio, "
                                + "\ninicio()\n"
                                + e.getMessage()
                                + "\n", "inicio()" );
                    }
